...
<form action="{{ route('comics.store') }}" method="POST" class="form-control">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" name="series" class="form-control" id="series" placeholder="Inserisci la serie" value="{{old('series')}}">
        </div>

         <div class="col">
            <label for="series" class="form-label">immagine</label>
            <input type="text" name="img" class="form-control" id="series" placeholder="Inserisci l' url dell' immagine" value="{{old('img')}}">
        </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="type" class="form-control" id="type" placeholder="Inserisci il tipo" value="{{old('type')}}">
    </div>
